...
const translations = {
	en: {
		...
		'header-description':
			"It's an invitation to break free from the ordinary, immerse yourself in diverse cultures, and embrace the beauty of the world around you.",
		...
		'service-weather-description':
			'Built Wicket longer admire do barton vanity itself do in it.',
		'service-flights-title': 'Best Flights',
		'service-flights-description':
		...
		'service-customization-description':
		...
		'booking-step1-description':
			'Choose your dream destination from our curated selection.',
		'booking-step2-title': 'Make Payment',
		'booking-step2-description':
			'Secure your adventure through our streamlined payment process.',
		'booking-step3-title': 'Reach Airport',
		'booking-step3-description':
			'Arrive at the airport on your selected date ready to embark.',
		...
		'client-1':
			"Booking my trips through this platform has been a game-changer! From the intuitive interface to the seamless booking process, I've never felt more excited to explore new destinations.",
		'client-2':
	...
	ar: {
		...
		'header-description':
			'إنها دعوة للتحرر من الروتين، والانغماس في ثقافات متنوعة، واحتضان جمال العالم من حولك.',
		...
		'service-weather-description':
			'بنيت ويكيت أطول تعجب تفعل بارتون الغرور نفسه يفعل ذلك فيه.',
		'service-flights-title': 'أفضل الرحلات الجوية',
		'service-flights-description':
			'الاستماع المستغرق. بوابة الحديقة تبيع هم الغرب بجد من أجل.',
		'service-events-title': 'الأحداث المحلية',
		'service-events-description':
			'غرور بارتون نفسه يفعل ذلك فيه. يفضل الرجال الاستماع المستغرق.',
		'service-customization-title': 'التخصيصات',
		'service-customization-description':
			'نحن نقدم خدمات الطيران الخارجية للعملاء العسكريين.',
		...
		'booking-step2-description':
			'أكمل حجزك بأمان من خلال خيارات الدفع السهلة لدينا.',
		'booking-step3-title': 'الوصول إلى المطار في التاريخ المحدد',
		'booking-step3-description':
			'وصل إلى المطار في التاريخ الذي اخترته وابدأ مغامرتك.',
		...
		'client-1':
			'كان حجز رحلاتي من خلال هذه المنصة بمثابة تغيير قواعد اللعبة! من الواجهة البديهية إلى عملية الحجز السلسة، لم أشعر أبدًا بمزيد من الحماس لاستكشاف وجهات جديدة.',
		'client-2':
			'كمحترف مشغول، الوقت جوهري. جعل هذا الموقع تخطيط عطلتي نسيمًا، مما أتاح لي التركيز على ما يهم أكثر: صنع الذكريات مع عائلتي.',
		'client-3':
			'لقد كنت أستخدم هذه الخدمة لسنوات، ولم تخيب أبدًا. توفر الراحة في حجز رحلاتي الجوية والإقامة والأنشطة كلها في مكان واحد لي الوقت والتوتر في كل رحلة.',
		...
		'subscribe-title':
			'اشترك للحصول على معلومات وآخر الأخبار والعروض المثيرة الأخرى حول Jadoo',
		'subscribe-email-placeholder': 'بريدك الإلكتروني',
		'subscribe-button': 'اشترك',
		'footer-description':
			'احجز رحلتك في دقائق، واحصل على تحكم كامل لفترة أطول بكثير.',
